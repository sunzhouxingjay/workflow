...
public class MonitorController implements DataController {
    ...
    @CrossOrigin
    @RequestMapping(value="/getResByOid/{oid}",method = RequestMethod.GET)
    ...
    @Deprecated
    @RequestMapping(value = "/wfRequest", method = { RequestMethod.GET, RequestMethod.POST })
    public Map<String,Object> wfRequest(@RequestBody String req) throws InterruptedException, IOException, ExecutionException {
        // if (!loopStatus) {
        //     loopStatus=runableManager.startLoop(wfEngine,wfConfig.getFlushTimeInterval(),preExecutionCache);
        // }
